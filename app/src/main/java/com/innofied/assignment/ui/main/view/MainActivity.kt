...
import com.innofied.assignment.ui.main.adapter.MainAdapter
import com.innofied.assignment.ui.main.viewmodel.MainViewModel
import com.innofied.assignment.utils.Status
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        swipe_layout.setOnRefreshListener {
            ...
            // Mocking Pull to Refresh delay for API call
        ...
        mainViewModel.users.observe(this, {
            when (it.status) {
                ...
                Status.SUCCESS -> {//remove loading view
                   ...
                   // it.data?.users?.toMutableList()?.removeAll(mainUserList)
                    hideLoader()
